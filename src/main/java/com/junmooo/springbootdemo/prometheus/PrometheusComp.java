package com.junmooo.springbootdemo.prometheus;
...
@Component
public class PrometheusComp implements ApplicationContextAware {
    private static PrometheusComp instance;
    /**
     * 请求总数
     */
    ...
    public static PrometheusComp getInstance() {
        return instance;
    }
